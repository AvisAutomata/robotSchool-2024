...
public class Robot extends TimedRobot
{
    ...
    public void teleopPeriodic() {
        ...
        if (Math.abs(Constants.joystick.getZ()) > 0.3)
        {
            Constants.left.set(VictorSPXControlMode.PercentOutput, Constants.joystick.getZ() * Constants.speedMultiplier);
            Constants.right.set(VictorSPXControlMode.PercentOutput, Constants.joystick.getZ() * Constants.speedMultiplier);
        }
        else {
